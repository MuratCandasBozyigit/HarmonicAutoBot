...
def build_gui(root):  # <-- Fonksiyon adı da düzeltildi (builg değil, build)
    ...
    # Ana pencere root zaten main.py'den geldi!
    ...
    tk.Spinbox(control_frame, from_=50, to=1000, increment=50, textvariable=globals.limit_var, width=5).grid(row=0, column=6, padx=5)
    ...
    # Otomatik grafik güncellemesini başlat
